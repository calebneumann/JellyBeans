    ...
    return ListView(
      children: [
        Visibility(
          visible: _fnafState,
          child: FnafWidget(
              rand: randJump), //sends the randomly chose jumpscare asset
        ),
        Padding(
        ...
        Column(
          ...
          children: [
            ...
            Visibility(
              ...
              child: Listener(
                //listens for presses and drags on the slider (setState wouldn't work from another file idk why D: )
              ...
              leading: TextButton(
                ...
                onPressed: () {
                  player.play(AssetSource(
                      'audio/FNAF.mp3')); //plays a silly FNAF noise LOL GOTTEM
                  turnOnFNAF(true);
                  Timer.periodic(Duration(seconds: 3), (Timer t) {
                    if (!mounted) {
                      t.cancel();
                      if (isGoldenFreddy) {
                        //if golden freddy is chosen, the app crashes :)
                        exit(0);
                      }
                    } else {
                      setState(() {
